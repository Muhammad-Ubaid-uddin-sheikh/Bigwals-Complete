...
{/* Reasonable Pricing & Packaging for Businesses    */}{titleMaina}
            ...
            <div className="colm-banner" data-aos ="fade-up" ><div className="image-banner" id='image-digial-animation'   ><img src={gifSpace} alt="bannerimg" width="100%" style={{borderRadius:'100%'}} /></div></div>
        </div>
    </div>
    </div>
  )
