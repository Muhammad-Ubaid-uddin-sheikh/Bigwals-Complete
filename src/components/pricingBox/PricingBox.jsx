  ...
  return (
    <div className='PricingBox-main-div'> 
     <div className="row-procing-box">
        <div className="colm-pricing-box" id='colm-pricing-box'
      
        > 
                <div className="colm-main-pricing"  
               ...
               <div className="colm-pricing-inner-box"><div id='div-blank-padding'>
                {/* <h4 class="ribbon">Top Seller</h4> */}
               <div id='div-sytyle-pricing-top' style={{TextShadow:'2px 2px 2px black'}}>{title}</div></div></div>
               <div className="colm-pricing-inner-box"><small className='small-pricing'>Starting From</small><div className='pricinbg-page-box'>{price}
               
               {/* <small className='small-pricing-old'>{previousPrice}</small>  */}
               </div></div>
